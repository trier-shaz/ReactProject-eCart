  ...
  constructor(){
    ...
    this.state = {
        ...
        },
        {
            ...
            title: 'Mobile Phone',
            qty: 10,
            img: 'https://images.unsplash.com/photo-1520923642038-b4259acecbd7?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=706&q=80',
            id: 2
        },
        {
            price: 999,
  ...
  <div className="App">
    <Navbar count={this.getCartCount()} />
     <Cart 
      ...
      onDeletProduct={this.handleDeleteProduct}
    />
